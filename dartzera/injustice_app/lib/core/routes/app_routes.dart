...
import '../../presentation/views/subaccount_view.dart';
...
class AppRouteNames {
  ...
  static const subAccounts = 'sub_accounts';
}
...
class AppPaths {
  ...
  static const characters = '/characters';
  static const subAccounts = '/sub-accounts';
}
...
class AppRouter {
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: <RouteBase>[
      ...
      GoRoute(
        path: AppPaths.subAccounts,
        name: AppRouteNames.subAccounts,
        pageBuilder: (context, state) =>
            const NoTransitionPage(child: SubAccountsView()),
      ),
    ],
  );
}
